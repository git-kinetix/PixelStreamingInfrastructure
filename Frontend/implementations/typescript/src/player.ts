...
function myHandleResponseFunction(response: string) 
{
...
document.body.onload = function () {
    ...
    console.log("OnLoad from player.ts");
    stream.addResponseEventListener("handle_messages", myHandleResponseFunction);
}
